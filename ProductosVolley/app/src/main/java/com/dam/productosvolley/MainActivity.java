...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText edtCodigo, edtProducto, edtPrecio, edtFabricante;
    ...
    public void insertarProducto(View view){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://10.0.2.2/registrar_producto/insertar.php", new Response.Listener<String>() {
            @Override
    ...
    public void buscarProducto(View view) {
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest("http://10.0.2.2/registrar_producto/buscar.php?codigo="+edtCodigo.getText().toString(), new Response.Listener<JSONArray>() {
            @Override
    ...
    public void editarProducto(View view) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://10.0.2.2/registrar_producto/editar.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    public void eliminarProducto(View view) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://10.0.2.2/registrar_producto/eliminar.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
